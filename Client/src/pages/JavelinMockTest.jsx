              ...
              <div className="space-y-6">
                ...
                <div className='flex items-center justify-between gap-3'>
                  <button
                    ...
                    className="w-[60vw] flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-black rounded-3xl hover:shadow-2xl transition-all transform hover:-translate-y-1 disabled:opacity-50"
                  >
